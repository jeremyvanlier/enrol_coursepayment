...
$instance = $DB->get_record('enrol', array('id'=>$enrolid, 'enrol'=>'coursepayment'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/coursepayment/unenrolself.php', array('enrolid'=>$instance->id));
