...
class newaccount extends \moodleform {
    ...
    protected function definition() {
        ...
        // Email customer.
        $mform->addElement('text', 'email', get_string('form:email', 'enrol_coursepayment'), array('size' => '48',));
        ...
        // City customer.
        $mform->addElement('text', 'city', get_string('form:city', 'enrol_coursepayment'), array('size' => '48',));
