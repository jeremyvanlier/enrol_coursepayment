 ...
 *
 * @package    coursepaymentelement_digitalsignature
 * @copyright  2017 Mark Nelson <markn@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

namespace enrol_coursepayment\invoice\element\digitalsignature;
...
class element extends \enrol_coursepayment\invoice\element\image\element {
    ...
    public function render_form_elements($mform) {
        ...
        $mform->addElement('select', 'signaturefileid', get_string('digitalsignature', 'coursepaymentelement_digitalsignature'),
            self::get_signatures());

        $mform->addElement('text', 'signaturename', get_string('signaturename', 'coursepaymentelement_digitalsignature'));
        $mform->setType('signaturename', PARAM_TEXT);
        $mform->setDefault('signaturename', '');

        $mform->addElement('passwordunmask', 'signaturepassword',
            get_string('signaturepassword', 'coursepaymentelement_digitalsignature'));
        $mform->setType('signaturepassword', PARAM_TEXT);
        $mform->setDefault('signaturepassword', '');

        $mform->addElement('text', 'signaturelocation', get_string('signaturelocation', 'coursepaymentelement_digitalsignature'));
        $mform->setType('signaturelocation', PARAM_TEXT);
        $mform->setDefault('signaturelocation', '');

        $mform->addElement('text', 'signaturereason', get_string('signaturereason', 'coursepaymentelement_digitalsignature'));
        $mform->setType('signaturereason', PARAM_TEXT);
        $mform->setDefault('signaturereason', '');

        $mform->addElement('text', 'signaturecontactinfo',
            get_string('signaturecontactinfo', 'coursepaymentelement_digitalsignature'));
        ...
        $mform->addElement('filemanager', 'digitalsignature',
            get_string('uploaddigitalsignature', 'coursepaymentelement_digitalsignature'), '',
            $this->signaturefilemanageroptions);
    }
